...
- 🗂️ Category-based expense allocation with preset and custom icons  
...
All user data, including bill history, UPI details, and theme preferences, are stored locally in the browser using LocalStorage.  

No backend server or external database is used, ensuring user privacy and lightweight performance.
...
- ✈️ Trip and travel expense sharing  
